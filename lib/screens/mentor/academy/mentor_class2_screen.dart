...
class MentorClass2Screen extends StatefulWidget {
  const MentorClass2Screen({super.key});

  @override
  State<MentorClass2Screen> createState() => _Class2ScreenState();
}

/// Backwards compatibility alias
typedef ClassPlayerScreen = Class2Screen;

class _Class2ScreenState extends State<MentorClass2Screen> {
...
typedef Class2Screen = MentorClass2Screen;
