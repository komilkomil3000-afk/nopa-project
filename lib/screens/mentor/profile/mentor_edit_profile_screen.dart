...
class MentorEditProfileScreen extends StatefulWidget {
  ...
  const MentorEditProfileScreen({super.key, required this.user});

  @override
  State<MentorEditProfileScreen> createState() => _EditProfileScreenState();
}

class _EditProfileScreenState extends State<MentorEditProfileScreen> {
...
typedef EditProfileScreen = MentorEditProfileScreen;
