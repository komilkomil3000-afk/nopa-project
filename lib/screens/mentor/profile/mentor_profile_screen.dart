...
import 'package:nopa_app/screens/mentor/profile/mentor_edit_profile_screen.dart';
...
class MentorProfileScreen extends StatefulWidget {
  ...
  @override
  State<MentorProfileScreen> createState() => _ProfileScreenState();
}

class _ProfileScreenState extends State<MentorProfileScreen> {
  ...
  void _openEditProfile(UserModel user) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MentorEditProfileScreen(user: user),
      ),
    );
  }
...
typedef ProfileScreen = MentorProfileScreen;
