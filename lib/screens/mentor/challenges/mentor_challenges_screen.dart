...
class MentorChallengesScreen extends StatefulWidget {
  const MentorChallengesScreen({super.key});

  @override
  State<MentorChallengesScreen> createState() => _ChallengesScreenState();
}

class _ChallengesScreenState extends State<MentorChallengesScreen> {
...
typedef ChallengesScreen = MentorChallengesScreen;
