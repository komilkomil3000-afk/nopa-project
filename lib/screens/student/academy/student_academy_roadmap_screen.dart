...
class StudentAcademyRoadmapScreen extends StatefulWidget {
  const StudentAcademyRoadmapScreen({super.key});

  @override
  State<StudentAcademyRoadmapScreen> createState() => _StudentAcademyRoadmapScreenState();
}

class _StudentAcademyRoadmapScreenState extends State<StudentAcademyRoadmapScreen> {
...
typedef MapScreen = StudentAcademyRoadmapScreen;
