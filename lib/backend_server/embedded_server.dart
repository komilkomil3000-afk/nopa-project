...
class EmbeddedServer {
  ...
  void _seedData() {
    ...
    // Caravans
    _caravans.addAll([
      {'id': 'c1', 'name': 'یاوران علاءالملک', 'mentorId': 'm1', 'memberCount': 12, 'overallProgress': 0.78, 'groupPoints': 3500},
      {'id': 'c2', 'name': 'کاروان عمار', 'mentorId': 'm1', 'memberCount': 10, 'overallProgress': 0.58, 'groupPoints': 2450},
      {'id': 'c3', 'name': 'کاروان مالک', 'mentorId': 'm2', 'memberCount': 8, 'overallProgress': 0.42, 'groupPoints': 1800},
    ]);
    ...
    _submissions.addAll([
      {
        ...
        'status': 'pending',
        'submittedAt': DateTime.now().subtract(const Duration(minutes: 5)).toIso8601String(),
      }
    ]);
    ...
    _notifications.addAll([
      {
        ...
        'message': 'به سامانه یکپارچه مربیگری و دانش‌آموزی نپا خوش آمدید.',
        'type': 'alert',
        'isRead': false,
