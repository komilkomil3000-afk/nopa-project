...
const startMarker = '<div class="panel-card glass" id="caravan-workspace-box"';
const endMarker = '  </div>\n        </section>\n  \n        <!-- TAB 5: CONTENT & ANNOUNCEMENTS -->';
...
const newBlock = `<div class="panel-card glass" id="caravan-workspace-box" style="margin-top: 24px; padding: 24px; border-radius: 16px; background: rgba(15, 23, 42, 0.7); border: 1px solid rgba(255,255,255,0.08);">
...
// Only replace up to the '</div>' before </section>
const actualEndIdx = endIdx + '  </div>\n'.length;
const newContent = content.substring(0, startIdx) + newBlock + '\n' + content.substring(actualEndIdx);
