...
router.post('/lms/clips', lmsController_1.createOrUpdateClip);
router.put('/lms/clips/:id', lmsController_1.createOrUpdateClip);
...
router.get('/leaderboard/individuals', leagueController_1.getIndividualsLeaderboard);
router.get('/leaderboard/caravans', leagueController_1.getCaravansLeaderboardDetailed);
