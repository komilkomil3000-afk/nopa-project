...
exports.getMentorAnalytics = exports.getDashboardAnalytics = void 0;
...
const getMentorAnalytics = async (req, res) => {
    try {
        ...
        res.json({
            ...
            reviewBreakdown: reviewStats.reduce((acc, item) => ({
                ...acc,
...
exports.getMentorAnalytics = getMentorAnalytics;
